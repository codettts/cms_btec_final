		...
		<form action="<c:url value='admin/user-manage'/>"
			...
			<div id="main-content">
				<div class="right-content">
					...
					<div id="User" class="tab-content user-overview">
	...
	function addNew(data) {
		$.ajax({
            ...
            success: function (result) {
            	window.location.href = "${usermanageURL}?username="+result.username+"&message=insert_success";
            },
            error: function (error) {
            	window.location.href = "${editAccURL}?page=1&limit=2&message=error_system";
            }
        });
	}
